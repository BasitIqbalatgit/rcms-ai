...
const Features = () => {
  return (
    <section
      id="features"
      className="py-12 w-full relative flex flex-col items-center justify-center bg-white sm:py-16 lg:py-20"
    >
      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="w-full max-w-5xl mx-auto text-center">
          <h2 className="text-3xl font-bold leading-tight  xl:text-5xl">
            Experience Car Modifications
            <br/> Like Never Before
          </h2>
          <p className="mt-4 max-w-2xl mx-auto leading-7 sm:mt-8 font-pj text-lg font-medium text-gray-600 font-pj">
            Our platform leverages advanced AI and computer vision to create realistic previews of car modifications – all before any physical work begins.
          </p>
        </div>

        <div className="grid grid-cols-1 mt-10 text-center sm:mt-16 sm:grid-cols-2 sm:gap-x-12 gap-y-12 md:grid-cols-3 md:gap-0 xl:mt-24">
          {/* Card 1: Realistic Previews */}
          ...
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
            ...
            <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Advanced AI</h3>
            <p className="mt-5 text-base text-gray-600 font-pj">
              Our state-of-the-art AI and computer vision analyze each image, ensuring modifications are precise and detailed.
            </p>
          </div>

          {/* Card 3: Interactive Visualization */}
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200">
            ...
            <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Interactive Visualization</h3>
            <p className="mt-5 text-base text-gray-600 font-pj">
              Let customers interact with the preview, exploring different modification options in real-time.
            </p>
          </div>
          ...
          <div className="md:p-8 lg:p-14 md:border-t md:border-gray-200">
            ...
            <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Seamless Integration</h3>
            <p className="mt-5 text-base text-gray-600 font-pj">
              Easily integrate our platform into your existing workflow for a smooth, user-friendly experience for your team.
            </p>
          </div>

          {/* Card 5: Boost Conversions */}
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
            ...
            <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Boost Conversions</h3>
            <p className="mt-5 text-base text-gray-600 font-pj">
              Increase customer trust and drive sales by providing an accurate, digital preview of modifications before any work begins.
            </p>
          </div>

          {/* Card 6: Insightful Analytics */}
          <div className="md:p-8 lg:p-14 md:border-l md:border-gray-200 md:border-t">
            ...
            <h3 className="mt-12 text-xl font-bold text-gray-900 font-pj">Insightful Analytics</h3>
            <p className="mt-5 text-base text-gray-600 font-pj">
              Monitor customer trends and performance metrics to continuously refine your service offerings and boost growth.
            </p>
          </div>
        </div>
      </div>
