...
const Testimonials = () => {
    return (
        <section className="w-full py-32 space-y-3  bg-muted px-6 xs:px-8 sm:px-0 sm:mx-8 lg:mx-auto overflow-hidden  flex flex-col items-center justify-center ">
            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div className="flex flex-col items-center">
                    <div className="w-full max-w-5xl mx-auto text-center">
                        ...
                        <h2 className="text-3xl font-bold leading-tight  xl:text-5xl">Our happy clients say about us</h2>
                    </div>
